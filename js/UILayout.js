...
const UI_LAYOUT = [
    ...
    { id: 'screenMain', kind: 'screen', anchor: 'top-left', x: 0, y: 0, w: 2560, h: 1440, fill: '#0b0e15', border: '', radius: 0, alpha: 0.97, visible: 0 },
    { id: 'screenModal', kind: 'screen', anchor: 'middle-center', x: 0, y: 0, w: 760, h: 540, fill: '#141b28', border: '#c8a24a', radius: 14, alpha: 1, visible: 0 },
    { id: 'cineFx', kind: 'screen', anchor: 'top-left', x: 0, y: 0, w: 2560, h: 1440, fill: '', border: '', radius: 0, alpha: 1, visible: 0 },
    ...
    { id: 'cineCard', kind: 'screen', anchor: 'top-left', x: 0, y: 0, w: 2560, h: 1440, fill: '', border: '', radius: 0, alpha: 1, visible: 0 },
